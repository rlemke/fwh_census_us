...
METRICS: list[Metric] = [
    ...
    Metric("obesity", "Adult obesity", "pct", "high", False,
           raw="chr_obesity", scale=1.0, national_only=True),
    Metric("life_expectancy", "Life expectancy", "years", "low", False,
           raw="chr_life_expectancy", scale=1.0, national_only=True),
    Metric("smoking", "Adult smoking", "pct", "high", False,
           raw="chr_smoking", scale=1.0, national_only=True),
    Metric("diabetes", "Diagnosed diabetes", "pct", "high", False,
           raw="chr_diabetes", scale=1.0, national_only=True),
    Metric("heart_disease", "Heart disease deaths per 100k (35-64)", "per100k", "high", False,
           raw="cdc_heart_disease", scale=1.0, national_only=True),
    Metric("cancer_mortality", "Cancer deaths per 100k", "per100k", "high", False,
